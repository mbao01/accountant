...
const colors = {
  ...
  */
  ...
  gray: {
    100: "hsl(193deg 18% 98%)",
    200: "hsl(196deg 18% 95%)",
    300: "hsl(200deg 18% 85%)",
    400: "hsl(203deg 18% 75%)",
  ...
  red: {
    100: "hsl(348deg 60% 97%)",
    200: "hsl(351deg 56% 87%)",
  ...
  blue: {
    100: "hsl(198deg 60% 97%)",
    200: "hsl(201deg 56% 87%)",
  ...
  green: {
    100: "hsl(147deg 60% 97%)",
    200: "hsl(144deg 56% 87%)",
  ...
  purple: {
    100: "hsl(268deg 60% 97%)",
    200: "hsl(265deg 56% 87%)",
...
module.exports = {
  ...
  safelist: [
    {
      pattern: /^(bg-|border-|text-|h-|w-|m-|mx-|my-|p-|px-|py-|after:bg-)/,
